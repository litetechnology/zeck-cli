...
import connectSsh from "./utils/connectSsh.js";
import executeCommand from "./utils/cmd.js";
    ...
    for (const dir of commandDirectories) {
        ...
        for (const file of cmds) {
            ...
            if (cmd?.name) {
                ...
                .action((...args) => cmd.run({ program, logger, json, translactions, prompt, cmd: executeCommand, connectSsh}, {...args}) );
            } else {
                continue;
            }
        }
